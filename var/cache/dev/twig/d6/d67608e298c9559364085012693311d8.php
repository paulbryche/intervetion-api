...
class __TwigTemplate_66eb78f1a99a5552cbf7b1af4fd8c0b7 extends Template
{
...
<div id=\"sfToolbarMainContent-{{ token }}\" class=\"sf-toolbarreset notranslate clear-fix\" data-no-turbolink data-turbo=\"false\">
    ...
    <button class=\"sf-toolbar-toggle-button\" type=\"button\" id=\"sfToolbarToggleButton-{{ token }}\" accesskey=\"D\" aria-expanded=\"true\" aria-controls=\"sfToolbarMainContent-{{ token }}\" aria-label=\"Toggle Symfony Toolbar\">
        <i class=\"sf-toolbar-icon-opened\" title=\"Close Toolbar\">{{ source(\x27@WebProfiler/Icon/close.svg\x27) }}</i>
        <i class=\"sf-toolbar-icon-closed\" title=\"Open Toolbar\">{{ source(\x27@WebProfiler/Icon/symfony.svg\x27) }}</i>
    </button>
</div>
", "@WebProfiler/Profiler/toolbar.html.twig", "/home/brychepaul/Workspace/intervetion-api/intervention-api/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/toolbar.html.twig");
    }
}
