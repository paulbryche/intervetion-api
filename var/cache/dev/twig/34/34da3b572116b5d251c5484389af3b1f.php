...
/* base.html.twig */
class __TwigTemplate_8c8c10ddb4745d2dd95fde78d42b0e84 extends Template
{
...
<html>
    <head>
        ...
        {% block javascripts %}
            {% block importmap %}{{ importmap(\x27app\x27) }}{% endblock %}
        {% endblock %}

        {% set frankenphpHotReload = app.request.server.get(\x27FRANKENPHP_HOT_RELOAD\x27) %}
...
", "base.html.twig", "/home/brychepaul/Workspace/intervetion-api/intervention-api/templates/base.html.twig");
    }
}
