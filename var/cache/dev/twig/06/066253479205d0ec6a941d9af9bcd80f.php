...
class __TwigTemplate_7b3715daaa43dd9a7e2ed6a2a53bbda5 extends Template
{
...
";
    ...
    ";
        ...
        <table>
            ...
            $context['_seq'] = CoreExtension::ensureTraversable(Twig\Extension\CoreExtension::sort($this->env, $this->env->hasExtension(\Twig\Extension\SandboxExtension::class) && $this->env->getExtension(\Twig\Extension\SandboxExtension::class)->isSandboxed($this->source), Twig\Extension\CoreExtension::keys(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 315, $this->source); })()), "bundles", [], "any", false, false, false, 315))));
...
{% block toolbar %}
    ...
    {% set text %}
        ...
        <div class=\"sf-toolbar-info-group\">
            ...
            <div class=\"sf-toolbar-info-piece sf-toolbar-info-php-ext\">
                <b>PHP Extensions</b>
                <span class=\"sf-toolbar-status sf-toolbar-status-{{ collector.hasXdebug ? \x27green\x27 : \x27gray\x27 }}\">
                    {% if collector.hasXdebugInfo %}
                        <a href=\"{{ path(\x27_profiler_xdebug\x27) }}\" title=\"View xdebug_info()\">
                    {% endif %}
                    Xdebug {{ collector.hasXdebug ? \x27✓\x27 : \x27✗\x27 }}
                    {% if collector.hasXdebugInfo %}
                        </a>
                    {% endif %}
                </span>
    ...
    {{ include(\x27@WebProfiler/Profiler/toolbar_item.html.twig\x27, {link: true, name: \x27config\x27, status: block_status, additional_classes: \x27sf-toolbar-block-right\x27}) }}
{% endblock %}
...
{% block panel %}
    ...
    <div class=\"metrics\">
        <div class=\"metric-group\">
            <div class=\"metric\">
                <span class=\"value value-is-icon {{ not collector.haszendopcache ? \x27value-shows-no-color\x27 }}\" title=\"{{ collector.zendopcachestatus|default(\x27\x27) }}\">{{ source(\x27@WebProfiler/Icon/\x27 ~ (collector.haszendopcache ? \x27yes\x27 : \x27no\x27) ~ \x27.svg\x27) }}</span>
                <span class=\"label\">OPcache</span>
            </div>

            <div class=\"metric\">
                <span class=\"value value-is-icon {{ not collector.hasapcu ? \x27value-shows-no-color\x27 }}\" title=\"{{ collector.apcustatus|default(\x27\x27) }}\">{{ source(\x27@WebProfiler/Icon/\x27 ~ (collector.hasapcu ? \x27yes\x27 : \x27no\x27) ~ \x27.svg\x27) }}</span>
                <span class=\"label\">APCu</span>
            </div>

            <div class=\"metric\">
                {% if collector.hasXdebugInfo %}
                    <a href=\"{{ path(\x27_profiler_xdebug\x27) }}\" title=\"View xdebug_info()\" class=\"link\">
                {% endif %}
                <span class=\"value value-is-icon {{ not collector.hasxdebug ? \x27value-shows-no-color\x27 }}\" title=\"{{ collector.xdebugstatus|default(\x27\x27) }}\">{{ source(\x27@WebProfiler/Icon/\x27 ~ (collector.hasxdebug ? \x27yes\x27 : \x27no\x27) ~ \x27.svg\x27) }}</span>
                <span class=\"label\">Xdebug</span>
                {% if collector.hasXdebugInfo %}
                    </a>
                {% endif %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "/home/brychepaul/Workspace/intervetion-api/intervention-api/vendor/symfony/web-profiler-bundle/Resources/views/Collector/config.html.twig");
    }
}
