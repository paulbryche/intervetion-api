...
class __TwigTemplate_de6a18df3cd30b0f57a85db3fb92d635 extends Template
{
...
{%- block form_errors -%}
    {%- if errors|length > 0 -%}
        {%- for error in errors -%}
            <div class=\"{% if form is not rootform %}invalid-feedback{% else %}alert alert-danger{% endif %} d-block\" id=\"{{ id ~ \x27_error\x27 ~ loop.index }}\">{{ error.message }}</div>
        {%- endfor -%}
    {%- endif %}
...
{%- block form_help -%}
    ...
    {{- parent() -}}
{%- endblock form_help %}
", "bootstrap_5_layout.html.twig", "/home/brychepaul/Workspace/intervetion-api/intervention-api/vendor/symfony/twig-bridge/Resources/views/Form/bootstrap_5_layout.html.twig");
    }
}
