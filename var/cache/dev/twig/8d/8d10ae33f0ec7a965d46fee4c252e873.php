...
class __TwigTemplate_7012633bf3d82f4618c0962e9caa53e7 extends Template
{
...
(isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 268, $this->source); })())]);
    ...
    {
        return new Source("{% extends \x27form_div_layout.html.twig\x27 %}
...
{% block form_errors -%}
    {% if errors|length > 0 -%}
        ...
        {%- for error in errors -%}
            <span id=\"{{ id ~ \x27_error\x27 ~ loop.index }}\">{{ error.message }}</span>{% if not loop.last %}, {% endif %}
        {%- endfor -%}
        {% if form is not rootform %}</small>{% else %}</div>{% endif %}
    {%- endif %}
{%- endblock form_errors %}
", "foundation_5_layout.html.twig", "/home/brychepaul/Workspace/intervetion-api/intervention-api/vendor/symfony/twig-bridge/Resources/views/Form/foundation_5_layout.html.twig");
    }
}
