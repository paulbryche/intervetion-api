...
class __TwigTemplate_6ea491c606431fcaa3688ddd0e0a632d extends Template
{
...
{%- block form_errors -%}
    {%- if errors|length > 0 -%}
        <ul>
            {%- for error in errors -%}
                <li class=\"{{ error_item_class|default(\x27text-red-700\x27) }}\" id=\"{{ id ~ \x27_error\x27 ~ loop.index }}\">{{ error.message }}</li>
            {%- endfor -%}
        </ul>
    {%- endif -%}
...
{%- block checkbox_row -%}
    ...
    {%- set widget_attr = {} -%}
    {%- if help -%}
        {%- set widget_attr = {attr: {\x27aria-describedby\x27: id ~ \x27_help\x27}} -%}
    {%- endif -%}
...
", "tailwind_2_layout.html.twig", "/home/brychepaul/Workspace/intervetion-api/intervention-api/vendor/symfony/twig-bridge/Resources/views/Form/tailwind_2_layout.html.twig");
    }
}
