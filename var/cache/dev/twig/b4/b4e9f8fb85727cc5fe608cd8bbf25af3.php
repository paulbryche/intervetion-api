...
class __TwigTemplate_b60f33923459218b1a95093bf64112aa extends Template
{
...
(isset($context["block_prefixes"]) || array_key_exists("block_prefixes", $context) ? $context["block_prefixes"] : (function () { throw new RuntimeError('Variable "block_prefixes" does not exist.', 288, $this->source); })())) ||  !((isset($context["label"]) || array_key_exists("label", $context) ? $context["label"] : (function () { throw new RuntimeError('Variable "label" does not exist.', 288, $this->source); })()) === false))) {
    ...
    public function block_form_row(array $context, array $blocks = []): iterable
    {
        ...
        if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new RuntimeError('Variable "errors" does not exist.', 352, $this->source); })())) > 0)) {
            // line 353
            $context["aria_describedby"] = Twig\Extension\CoreExtension::merge((isset($context["aria_describedby"]) || array_key_exists("aria_describedby", $context) ? $context["aria_describedby"] : (function () { throw new RuntimeError('Variable "aria_describedby" does not exist.', 353, $this->source); })()), Twig\Extension\CoreExtension::map($this->env, $this->env->hasExtension(\Twig\Extension\SandboxExtension::class) && $this->env->getExtension(\Twig\Extension\SandboxExtension::class)->isSandboxed($this->source), (isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new RuntimeError('Variable "errors" does not exist.', 353, $this->source); })()), function ($_____, $__index__) use ($context, $macros) { $context["_"] = $_____; $context["index"] = $__index__; return (((isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 353, $this->source); })()) . "_error") . ((isset($context["index"]) || array_key_exists("index", $context) ? $context["index"] : (function () { throw new RuntimeError('Variable "index" does not exist.', 353, $this->source); })()) + 1)); }));
        }
        // line 355
    ...
    public function block_form_rows(array $context, array $blocks = []): iterable
    {
        ...
        // line 448
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(Twig\Extension\CoreExtension::filter($this->env, $this->env->hasExtension(\Twig\Extension\SandboxExtension::class) && $this->env->getExtension(\Twig\Extension\SandboxExtension::class)->isSandboxed($this->source), (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 448, $this->source); })()), function ($__child__) use ($context, $macros) { $context["child"] = $__child__; return  !CoreExtension::getAttribute($this->env, $this->source, $context["child"], "rendered", [], "any", false, false, false, 448); }));
        foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
            // line 449
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($context["child"], 'row');
        }
...
{%- block time_widget -%}
    {%- if widget == \x27single_text\x27 -%}
        {{ block(\x27form_widget_simple\x27) }}
    {%- else -%}
        {%- set vars = widget == \x27text\x27 ? {attr: {size: 1}} : {} -%}
        <div {{ block(\x27widget_container_attributes\x27) }}>
...
{%- block form_label_content -%}
    {%- if not label -%}
        ...
        {%- elseif \x27button\x27 not in block_prefixes or label is not same as(false) -%}
...
{%- block form_row -%}
    ...
    {%- if help -%}
        {%- set aria_describedby = aria_describedby|merge([id ~ \x27_help\x27]) -%}
    {%- endif -%}
    {%- if errors|length > 0 -%}
        {%- set aria_describedby = aria_describedby|merge(errors|map((_, index) => id ~ \x27_error\x27 ~ (index + 1))) -%}
    {%- endif -%}
    {%- if aria_describedby|length > 0 -%}
        {%- set attr = attr|merge({\x27aria-describedby\x27: aria_describedby|join(\x27 \x27)}) -%}
    {%- endif -%}
    {%- if errors|length > 0 -%}
        {%- set attr = attr|merge({\x27aria-invalid\x27: \x27true\x27}) -%}
    {%- endif -%}
    {%- set widget_attr = {attr: attr} -%}
    {{- block(\x27form_row_render\x27) -}}
{%- endblock form_row -%}
...
{%- block form_start -%}
    ...
    {%- if method in [\x27GET\x27, \x27POST\x27] -%}
        {% set form_method = method %}
    {%- else -%}
        {% set form_method = \x27POST\x27 %}
    {%- endif -%}
...
{%- block form_errors -%}
    ...
    <ul>
        {%- for error in errors -%}
            <li id=\"{{ id ~ \x27_error\x27 ~ loop.index }}\">{{ error.message }}</li>
        {%- endfor -%}
    </ul>
    {%- endif -%}
...
{% block attributes -%}
    ...
    {%- endfor -%}
{%- endblock attributes -%}
", "form_div_layout.html.twig", "/home/brychepaul/Workspace/intervetion-api/intervention-api/vendor/symfony/twig-bridge/Resources/views/Form/form_div_layout.html.twig");
    }
}
