 ...
 */
class get_ServiceLocator_UBzcXBfService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.uBzcXBf'])) {
            return $container->privates['.service_locator.uBzcXBf'];
        }

        return $container->privates['.service_locator.uBzcXBf'] = $instance;
    }
}
