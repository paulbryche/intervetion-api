...
require_once __DIR__.\DIRECTORY_SEPARATOR.'ApiPlatform'.\DIRECTORY_SEPARATOR.'JsonapiConfig.php';
...
require_once __DIR__.\DIRECTORY_SEPARATOR.'ApiPlatform'.\DIRECTORY_SEPARATOR.'McpConfig.php';
...
class ApiPlatformConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    /**
     * @default {"use_iri_as_id":true,"allow_client_generated_id":false}
     * @deprecated since Symfony 7.4
     */
    public function jsonapi(array $value = []): \Symfony\Config\ApiPlatform\JsonapiConfig
    {
        $this->_hasDeprecatedCalls = true;
        if (null === $this->jsonapi) {
            $this->_usedProperties['jsonapi'] = true;
            $this->jsonapi = new \Symfony\Config\ApiPlatform\JsonapiConfig($value);
        } elseif (0 < \func_num_args()) {
            throw new InvalidConfigurationException('The node created by "jsonapi()" has already been initialized. You cannot pass values the second time you call jsonapi().');
        }
     ...
     * @deprecated since Symfony 7.4
     */
    public function enableScalar($value): static
    {
        $this->_hasDeprecatedCalls = true;
        $this->_usedProperties['enableScalar'] = true;
        $this->enableScalar = $value;
     ...
     * @default true
     * @param ParamConfigurator|bool $value
     * @deprecated Since api-platform/symfony 4.2: This option is always enabled and will be removed in API Platform 5.0.
     * @return $this
     * @deprecated since Symfony 7.4
     */
     ...
     * @template TValue of array|bool
     * @param TValue $value
     * @default {"enabled":false,"default_ide":"graphiql","graphiql":{"enabled":false},"introspection":{"enabled":true},"max_query_depth":20,"graphql_playground":{"enabled":false},"max_query_complexity":500,"nesting_separator":"_","collection":{"pagination":{"enabled":true}}}
     ...
     * @template TValue of array|bool
     * @param TValue $value
     * @default {"enabled":false,"hosts":[],"ssl_ca_bundle":null,"ssl_verification":true,"client":"elasticsearch"}
    ...
    /**
     * @default {"contact":{"name":null,"url":null,"email":null},"termsOfService":null,"tags":[],"license":{"name":null,"url":null,"identifier":null},"swagger_ui_extra_configuration":[],"scalar_extra_configuration":[],"overrideResponses":true,"error_resource_class":null,"validation_error_resource_class":null}
     * @deprecated since Symfony 7.4
     */
     ...
     * @template TValue of array|bool
     * @param TValue $value
     * @default {"enabled":true,"namespace_prefix":""}
     ...
     * @template TValue of array|bool
     * @param TValue $value
     * @default {"enabled":true,"format":"jsonld"}
     * @return \Symfony\Config\ApiPlatform\McpConfig|$this
     * @psalm-return (TValue is array ? \Symfony\Config\ApiPlatform\McpConfig : static)
     * @deprecated since Symfony 7.4
     */
    public function mcp(array|bool $value = []): \Symfony\Config\ApiPlatform\McpConfig|static
    {
        $this->_hasDeprecatedCalls = true;
        if (!\is_array($value)) {
        ...
        if (!$this->mcp instanceof \Symfony\Config\ApiPlatform\McpConfig) {
            $this->_usedProperties['mcp'] = true;
            $this->mcp = new \Symfony\Config\ApiPlatform\McpConfig($value);
        } elseif (0 < \func_num_args()) {
            throw new InvalidConfigurationException('The node created by "mcp()" has already been initialized. You cannot pass values the second time you call mcp().');
        }
    ...
    public function __construct(array $config = [])
    {
        ...
        if (array_key_exists('jsonapi', $config)) {
            $this->_usedProperties['jsonapi'] = true;
            $this->jsonapi = new \Symfony\Config\ApiPlatform\JsonapiConfig($config['jsonapi']);
            unset($config['jsonapi']);
        }
        ...
        if (array_key_exists('enable_scalar', $config)) {
            $this->_usedProperties['enableScalar'] = true;
            $this->enableScalar = $config['enable_scalar'];
            unset($config['enable_scalar']);
        }
        ...
        if (array_key_exists('mcp', $config)) {
            $this->_usedProperties['mcp'] = true;
            $this->mcp = \is_array($config['mcp']) ? new \Symfony\Config\ApiPlatform\McpConfig($config['mcp']) : $config['mcp'];
            unset($config['mcp']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['jsonapi'])) {
            $output['jsonapi'] = $this->jsonapi->toArray();
        }
        ...
        if (isset($this->_usedProperties['enableScalar'])) {
            $output['enable_scalar'] = $this->enableScalar;
        }
        ...
        if (isset($this->_usedProperties['mcp'])) {
            $output['mcp'] = $this->mcp instanceof \Symfony\Config\ApiPlatform\McpConfig ? $this->mcp->toArray() : $this->mcp;
        }
